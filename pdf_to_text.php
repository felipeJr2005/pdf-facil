...
$log_path = $log_dir . '/pdf_text_log.txt';

// Iniciar arquivo de log
file_put_contents($log_path, "[" . date('Y-m-d H:i:s') . "] Iniciando extração de texto\n");
...
try {
    ...
    // URL da API
    $api_url = "https://pdffacil-jwuynw.fly.dev/pdf-to-text/";
    ...
    logMessage("Enviando resposta JSON para o cliente");
    header('Content-Type: application/json');
    echo $response;
    logMessage("Extração concluída com sucesso");
