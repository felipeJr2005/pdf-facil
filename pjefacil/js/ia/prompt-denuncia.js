...

{
  ...
  "testemunhasPoliciais": [{"qualificacaoCompleta": "NOME COMPLETO / MATRÍCULA", "tipo": "PM|PC|PF|PRF|GM|PP", "lotacao": ""}],
  "testemunhasDefesa": [],
  "procuradorRequerido": [],
  "outros": [{"nome": "", "motivo": ""}],
...
- Adicionar telefone quando houver (réus, vítimas, testemunhas gerais). Policiais: apenas "NOME COMPLETO / MATRÍCULA" (sem telefone).
